...
static VgSchedReturnCode thread_wrapper(Word /*ThreadId*/ tidW)
{
   ...
   VG_(debugLog)(1, "syswrap-linux", 
                    ...
                    tid);
#if DBG_REWHY
	 VG_(printf)("REWHY: thread_wrapper(tid=%u): entry\n", tid);
#endif
...
#if DBG_REWHY
	 VG_(printf)("REWHY: thread_wrapper(tid=%u): exit, schedreturncode %s\n", tid, VG_(name_of_VgSchedReturnCode)(ret));
#endif
...
#if DBG_REWHY
	 VG_(printf)("REWHY: run_a_thread_NORETURN(tid=%u): pre_thread_wrapper.\n", tid);
#endif
...
#if DBG_REWHY
	 VG_(printf)("REWHY: run_a_thread_NORETURN(tid=%u): post-thread_wrapper.\n", tid);
#endif
