...
vg_local_src_files := \
	...
	malton/dt_stmt2.c \
	malton/dt_syswrap.c \
	malton/dt_translate.c \
	malton/dt_mem_wrappers.c \
...
# Build fuzzgrind-$(TARGET_ARCH)-linux
vg_local_module := fuzzgrind
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := EXECUTABLE
...
vg_local_src_files := \
	fuzzgrind/fz_main.c \
	fuzzgrind/fz_syswrap.c \
	fuzzgrind/fz_translate.c \
	fuzzgrind/copy.c \
	fuzzgrind/fz_util.c 
...
# Build fuzzer-$(TARGET_ARCH)-linux
vg_local_module := fuzzer
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := EXECUTABLE
...
vg_local_src_files := \
	fuzzer/fz_main.c \
	fuzzer/shadow_memory.c \
	fuzzer/symbolic_execution.c \
	fuzzer/taint_analysis.c \
	fuzzer/util.c \
	fuzzer/copy.c \
	fuzzer/fz_mem_wrappers.c \
	fuzzer/fz_dexparse.c \
	fuzzer/fz_oatparse.c \
	fuzzer/fz_framework.c \
	fuzzer/fz_path_explorer.c
...
# Build vgpreload_fuzzer-$(TARGET_ARCH)-linux.so
vg_local_module := vgpreload_fuzzer
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := SHARED_LIBRARY
vg_local_no_crt := true

vg_local_src_files := \
	fuzzer/fz_art_wrapper.c
