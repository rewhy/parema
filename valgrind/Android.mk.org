...
# Build datatrace-$(TARGET_ARCH)-linux
vg_local_module := datatrace
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := EXECUTABLE
...
vg_local_src_files := \
	datatrace/dt_main.c \
	datatrace/dt_taint.c \
	datatrace/dt_stmt2.c \
	datatrace/dt_syswrap.c \
	datatrace/dt_translate.c \
	datatrace/dt_mem_wrappers.c \
	datatrace/dt_dexparse.c \
	datatrace/dt_oatparse.c \
	datatrace/copy.c
...
# Build vgpreload_datatrace-$(TARGET_ARCH)-linux.so
vg_local_module := vgpreload_datatrace
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := SHARED_LIBRARY
vg_local_no_crt := true

vg_local_src_files := \
	datatrace/dt_replace_wrapper.c
...
# Build bevgrind-$(TARGET_ARCH)-linux
vg_local_module := bevgrind
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := EXECUTABLE
...
vg_local_src_files := \
	bevgrind/bg_main.c \
	bevgrind/bg_stmt.c \
	bevgrind/bg_syswrap.c \
	bevgrind/bg_dexparse.c \
	bevgrind/bg_translate.c \
	bevgrind/bg_mem_wrappers.c \
	bevgrind/copy.c
...
# Build vgpreload_bevgrind-$(TARGET_ARCH)-linux.so
vg_local_module := vgpreload_bevgrind
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := SHARED_LIBRARY
vg_local_no_crt := true

vg_local_src_files := \
	bevgrind/bg_replace_wrapper.c
