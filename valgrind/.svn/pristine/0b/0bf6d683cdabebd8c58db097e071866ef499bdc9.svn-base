#ifndef _FZ_OAT_DEX_PARSE_H
#define _FZ_OAT_DEX_PARSE_H
...
Bool oatDexParse(Addr, UInt, Addr, UInt, Bool);
...
typedef 
	struct _Mth_stack {
		Addr	lr[MAX_STACK_SIZE];
		Addr	sp[MAX_STACK_SIZE];
...
Bool oatDexParse(Addr oatdata, UInt oatdata_size, Addr oatexec, UInt oatexec_size, Bool isBoot);
