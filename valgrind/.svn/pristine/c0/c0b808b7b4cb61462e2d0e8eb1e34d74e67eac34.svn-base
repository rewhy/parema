...
// if tmp GOTO ...
void DT_(smt2_exit) ( IRStmt *clone )
{
...
// ltmp = LOAD <ty> const 
void DT_(smt2_load_c_32) ( IRStmt *clone, UInt value, UInt taint )
{
...
// ltmp = LOAD <ty> const 
void DT_(smt2_load_c_64) ( IRStmt *clone, ULong value, ULong taint )
{
...
// ltmp = LOAD <ty> atmp
void DT_(smt2_load_t_32) ( IRStmt *clone, UInt value, UInt taint )
{
...
// ltmp = LOAD <ty> atmp
void DT_(smt2_load_t_64) ( IRStmt *clone, ULong value, ULong taint )
{
...
// STORE const = dtmp
void DT_(smt2_store_ct) ( IRStmt *clone )
{
...
// STORE atmp = const
void DT_(smt2_store_tc) ( IRStmt *clone )
{
...
// STORE atmp = dtmp
void DT_(smt2_store_tt) ( IRStmt *clone )
{
...
// ltmp = <op> rtmp
void DT_(smt2_unop_t) ( IRStmt *clone )
{
...
// ltmp = <op> rtmp1 c
void DT_(smt2_binop_tc) ( IRStmt *clone )
{
...
// ltmp = <op> c rtmp2
void DT_(smt2_binop_ct) ( IRStmt *clone )
{
...
// ltmp = <op> rtmp1 rtmp2
void DT_(smt2_binop_tt) ( IRStmt *clone )
{
   IRExpr* arg1 = clone->Ist.WrTmp.data->Iex.Binop.arg1;
   IRExpr* arg2 = clone->Ist.WrTmp.data->Iex.Binop.arg2;
   UInt rtmp1   = arg1->Iex.RdTmp.tmp;
...
// ltmp = rtmp
void DT_(smt2_rdtmp) ( IRStmt *clone )
{
...
// tmp = reg
void DT_(smt2_get) ( IRStmt *clone )
{
   UInt ltmp    = clone->Ist.WrTmp.tmp;
...
// reg = tmp
void DT_(smt2_put_t_32) ( IRStmt *clone )
{
...
// reg = tmp
void DT_(smt2_put_t_64) ( IRStmt *clone )
{
...
void DT_(smt2_x86g_calculate_condition) ( IRStmt *clone )
{
   UInt ltmp    = clone->Ist.WrTmp.tmp;
   IRExpr *data = clone->Ist.WrTmp.data;
...
void DT_(smt2_amd64g_calculate_condition) ( IRStmt *clone )
{
   UInt ltmp    = clone->Ist.WrTmp.tmp;
   IRExpr *data = clone->Ist.WrTmp.data;
   UInt ty      = data->Iex.CCall.retty - Ity_INVALID;
...
void DT_(smt2_ite_tt) ( IRStmt *clone )
{
   UInt ltmp    = clone->Ist.WrTmp.tmp;
   IRExpr *data = clone->Ist.WrTmp.data;
