...
DIST_COMMON = $(top_srcdir)/Makefile.all.am $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/datatrace/docs/Makefile.in \
	$(top_srcdir)/datatrace/tests/Makefile.in \
...
CONFIG_CLEAN_FILES = valgrind.spec valgrind.pc glibc-2.X.supp \
	drd/scripts/download-and-build-splash2 datatrace/docs/Makefile \
	datatrace/tests/Makefile
...
VG_TMPDIR = /sdcard 
abs_builddir = /home/jeremy/Data/AndroidSource/Android-M/external/valgrind
abs_srcdir = /home/jeremy/Data/AndroidSource/Android-M/external/valgrind
...
drd/scripts/download-and-build-splash2: $(top_builddir)/config.status $(top_srcdir)/drd/scripts/download-and-build-splash2.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
datatrace/docs/Makefile: $(top_builddir)/config.status $(top_srcdir)/datatrace/docs/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
datatrace/tests/Makefile: $(top_builddir)/config.status $(top_srcdir)/datatrace/tests/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
