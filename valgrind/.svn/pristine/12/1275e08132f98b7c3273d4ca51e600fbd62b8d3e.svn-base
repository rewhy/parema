...
/* Added by Rewhy */
extern Bool VG_(DebugInfo_is_oat)(const DebugInfo *di);
void VG_(print_sym_table)(const DebugInfo *di);
Bool VG_(get_symbol_range_SLOW)(const DebugInfo *di, const HChar* name,
                            Addr* avma,  SizeT* size);
Bool VG_(lookup_symbol)(const DebugInfo* si, const Addr addr, HChar** name);
