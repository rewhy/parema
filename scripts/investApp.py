    ...
    def genScriptFuzzer(self):
        ...
        for c in self.mainActivity:
            if c == '.':
                ...
                mainAct = mainAct + c
        #mainAct1 = 'java/lang/ClassLoader'
        ...
        #sf.write("VGPARAMS=\'-v --trace-children=yes --trace-symtab=yes --log-file=/data/local/tmp/fuzz/frw.log.%p --tool=none\'\n")
        ...
        #sf.write("VGPARAMS=\'-v --trace-children=yes --trace-symtab=yes --log-file=/data/local/tmp/fuzz/fuzzer.log.%p --trace-children=yes --valgrind-stacksize=8388608 --tool=deobfuscator " +
...
def getUnpackDex(package):
    os.system("adb pull /data/local/tmp/fuzz %s_log" % package)
    return
